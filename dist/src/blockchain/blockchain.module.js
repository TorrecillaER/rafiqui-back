...
const materials_blockchain_service_1 = require("./materials-blockchain.service");
...
exports.BlockchainModule = BlockchainModule = __decorate([
    (0, common_1.Module)({
        providers: [blockchain_service_1.BlockchainService, materials_blockchain_service_1.MaterialsBlockchainService],
        controllers: [blockchain_controller_1.BlockchainController],
        exports: [blockchain_service_1.BlockchainService, materials_blockchain_service_1.MaterialsBlockchainService],
    })
], BlockchainModule);
